...
import { getBasketballSeasonList, getBasketballMatchList } from '@/api/sport/basketball'
import { SeasonItem, BasketballMatchItem } from '../../types'
import ShowName from '@/components/sport/showName'
import NoneWrap from '@/components/common/noneContent'

const api = (data: ListParams): AxiosPromise => getBasketballSeasonList(data)
...
const SeasonList: React.FC = () => {
  ...
  useEffect((): void => {
    getBasketballMatchList({ size: 20 }).then((res): void => {
