...
import SortModal from '@/components/sport/football/sortModal'
import NoneWrap from '@/components/common/noneContent'
import ShowName from '@/components/sport/showName'


const api = (data: ListParams): AxiosPromise => getFootballMatchList(data)
        ...
        return (
          <div>
            <Button
              ...
              type="primary"
              onClick={(): void => {
                history.push(`/football/match/${value.id}`)
              }}
            >
              详情
            </Button>
                ...
                <Button
                  ...
                  onClick={(): void => {
                    Modal.confirm({
                      ...
                      icon: <ExclamationCircleOutlined />,
                      onOk() {
                        patchFootballStatus({ id: value.id }).then(() => {
                          changeStatusSuccess(value, index)
                        })
                      },
                    })
