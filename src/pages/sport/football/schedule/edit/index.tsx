...
import { FootballScheduleItem, FootballMatchItem, FootballTeamItem } from '@/pages/sport/football/types'
...
const FootballScheduleEdit: RefTable = (
    ...
    <div style={{ marginTop: '50px' }}>
      ...
      >
        ...
        >
          ...
          >
            {
              matchList.map((item: FootballMatchItem) => (
        ...
        >
          ...
          >
            {
              homeTeamList.map((item: FootballTeamItem) => (
                <Option key={item.id} value={item.id}>{item.shortName}</Option>
              ))
            }
          </Select>
        ...
        >
          ...
          >
            {
              guestTeamList.map((item: FootballTeamItem) => (
                <Option key={item.id} value={item.id}>{item.shortName}</Option>
              ))
            }
          </Select>
...
export default forwardRef(FootballScheduleEdit)
